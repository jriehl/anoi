...
class TestANOISpaces(unittest.TestCase):
    def _check_space(self, space: basis.ANOISpace):
        uid0 = space.get_uid()
        uid1 = space.get_uid()
        uid2 = space.get_uid()
...
class TestANOITrie(unittest.TestCase):
    def test_trie_and_compress(self):
        ...
        self.assertEqual(basis.compress(trie, vec3), (uid3, ))
